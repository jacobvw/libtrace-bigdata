...
int module_protocol_statistics_packet(libtrace_t *trace, libtrace_thread_t *thread,
...
int module_protocol_statistics_tick(libtrace_t *trace, libtrace_thread_t *thread,
...
int module_protocol_statistics_init() {
